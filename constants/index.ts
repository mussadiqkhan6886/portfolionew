...
export const projects = [
  {
    ...
    features: [
      ...
      "Technical SEO — schema markup, sitemap, meta optimization ([X]% organic traffic growth / ranked for [keyword])",
...

  {
    ...
    stack: "NEXT.JS ✦ MONGODB ✦ TYPESCRIPT ",
    description:
      "Zevora Official is a full-featured luxury accessories store I built and optimized for search from the ground up — six-plus product categories, COD checkout, and a scalable catalog engineered to compete with established local jewelry sellers with zero ad spend. I handled full technical and on-page SEO: structured data for every product and category, keyword-mapped city and product landing pages, and Core Web Vitals optimization to earn organic rankings in a highly competitive niche.",
    problemStatement:
    ...
    features: [
      ...
      "Local SEO — city + product keyword targeting, ranked page 1 for [X] terms",
...

  {
    ...
    features: [
      ...
      "SSR for Fast First Contentful Paint — [X]s FCP",
...

  {
    ...
    stack: "NEXT.JS ✦ MONGODB ✦ TYPESCRIPT",
    description:
      "M&Z Store is a full eCommerce build for a modest-fashion fabric brand — I structured the catalog schema around fabric type (lawn, organza, khaddi-net) rather than generic categories to match how customers actually shop, and used ISR so the client's weekly-rotating inventory reflects instantly without redeploys. On-page SEO was built around fabric-specific product titles and descriptions to capture long-tail search traffic in an otherwise unstructured, social-media-dominated market.",
    problemStatement:
    ...
    features: [
      ...
      "Fabric-Specific SEO Product Listings — ranked for [X] long-tail terms",
...

  {
    ...
    features: [
      ...
      "Mobile-First SEO Optimization — [X]s mobile load time",
...

  {
    ...
    features: [
      ...
      "FAQ Accordion",
      "Keyword-Targeted SEO for Fragrance Search Terms — ranked for [X] terms",
...

  {
    ...
    description:
      "Amass Bakery replaced unstructured WhatsApp/Instagram cake ordering with a self-serve, bilingual digital menu and custom cake builder — I implemented full i18n with proper RTL layout handling for Arabic, not just mirrored CSS, since Arabic typography and spacing needed dedicated attention. Local SEO was built around Al Khobar/Dammam search intent, with ISR keeping the menu and seasonal galleries current without redeploying.",
    problemStatement:
...

  {
    ...
    features: [
      ...
      "Author/About Page",
      "Per-Post Technical SEO (schema, meta, internal linking)",
      "SSG/ISR for New Blog Posts — published instantly, no rebuild",
      "Lighthouse Performance Score: [X]/100",
