...
export const projects = [
  {
    ...
    skillSet: ["nextjs", "mongodb", "cloudinary"],
    description:
      "Chunk'd Cookies is a premium cookie eCommerce platform built to deliver a seamless online ordering experience. Optimized for performance, SEO, and conversions, it helps the brand provide a fast, engaging shopping experience while simplifying online sales and order management.",
    problemStatement:
      "The client wanted a bold, premium cookie brand experience inspired by the energy of Apple and Crumbl clean, modern, and visually engaging. Beyond aesthetics, they needed a flexible ordering system supporting Build Your Own Box, Pre-Order Drops, Standard Orders, and Deals, along with a custom admin dashboard to manage products, orders, and business analytics efficiently.",
    mainObjective:
...

  {
    ...
    stack: "NEXT.JS ✦ MONGODB ✦ TYPESCRIPT ",
    description:
      "Zevora Official is a full-featured luxury accessories store selling watches, jewelry sets, rings, bracelets, perfumes and bags. The site was engineered for direct-to-consumer conversion, combining a premium visual identity with COD checkout, and a scalable multi-category catalog with full technical & On Page SEO.",
    problemStatement:
    ...
    features: [
      "Multi-Category Catalog (Watches, Jewelry, Rings, Perfumes, Bags)",
      ...
      "FAQ & Support Pages",
      "Heavy Local SEO (city + product keyword targeting)",
...

  {
    ...
    description:
      "True Horizon is an agency website for an AI automation and web development consultancy. It showcases services like workflow automation, AI voice agents, sales automation, and website development through interactive, animated product mock-ups rather than static screenshots, positioning the agency as builders rather than advisors.",
    problemStatement:
...

  {
    ...
    stack: "NEXT.JS ✦ MONGODB ✦ TYPESCRIPT",
    description:
      "M&Z Store is a full eCommerce platform for hijabs, chaddars, and dupattas targeting modest-fashion shoppers across Pakistan. The store organizes dozens of fabric variants (lawn, organza, khaddi-net) into clear collections and pairs them with a values-driven brand story to build customer loyalty.",
    problemStatement:
      "The modest-fashion fabric market in Pakistan is fragmented and price-driven, with most sellers operating through unstructured social media pages. The client needed a proper online store that could organize a large, fast-changing inventory of dupattas and chaddars by fabric type, communicate quality and trust to first-time buyers, and support cash-on-delivery, the dominant payment method for this audience.",
    mainObjective:
      "Give a modest-fashion brand a scalable catalog structure organized by fabric type, build shopper trust through reviews and clear policies, and make it effortless for the client to add new dupatta variants as inventory rotates weekly.",
    features: [
      "Fabric-Based Collection Structure (Lawn, Organza, Khaddi-Net)",
      "Cash on Delivery Checkout",
...

  {
    ...
    stack: "NEXT.JS ✦ MONGODB ✦ TYPESCRIPT",
    description:
      "MIRMEE sells handmade hair bows, scrunchies, headbands, formal hair accessories and nail products. The storefront was built to make small-batch, handcrafted items feel premium, with clean collection browsing, stock-status handling, and sale pricing built directly into the catalog.",
    problemStatement:
    ...
    features: [
      ...
      "Multi-Category Catalog (Bows, Claws, Scrunchies, Formals, Nails)",
      ...
      "Mobile-First, Lightweight Build",
    ],
...

  {
    ...
    stack: "NEXT.JS ✦ MONGODB ✦ TYPESCRIPT",
    description:
      "Halir Perfumery sells long-lasting eau de parfums and signature scents for men and women. The site was built around storytelling and sensory-driven design, using cinematic visuals, structured 'For Him / For Her' collections and a clear performance/longevity promise to justify premium pricing.",
    problemStatement:
      "Perfume is one of the hardest products to sell online since customers can't smell it before buying. The client needed a website that could sell the *feeling* of a fragrance through visuals, storytelling and trust signals like longevity claims and a return policy, strong enough to convert a cold visitor into a buyer purely on brand experience.",
    mainObjective:
      "Translate an intangible sensory product into a visually convincing, story-led brand website that builds enough trust and desire for visitors to buy a scent they've never smelled, while ranking for competitive 'perfume in Pakistan' search terms.",
    features: [
      ...
      "30-Day Return Assurance Messaging",
      "FAQ Accordion",
      "SEO Optimized for Fragrance Keywords",
      "ISR for Product Catalog",
      "Cloudinary Media Optimization",
      "Cinematic, Mobile-First Visual Design",
    ],
...

  {
    ...
    stack: "NEXT.JS ✦ MONGODB ✦ TYPESCRIPT",
    description:
      "KPSLA is the official platform for a student leadership organization in Khyber Pakhtunkhwa, Pakistan. The site presents the organization's mission, leadership team, programs, and impact stats, while handling student membership registration and event visibility for a province-wide, mostly Grade 7-12 audience.",
    problemStatement:
    ...
    features: [
      ...
      "SEO Optimized for Regional Reach",
      "SSR for Fast, Crawlable Content",
...

  {
    ...
    description:
      "Amass Bakery is a custom cakes and artisanal pastry brand serving Al Khobar and Dammam. The site combines a full digital menu, a cake customization flow, occasion and wedding cake galleries, and table setup services, all delivered in both English and Arabic for the local market.",
    problemStatement:
    ...
    features: [
      "Bilingual Site (English / Arabic with RTL support)",
      ...
      "Digital Menu (Cakes, Cupcakes, Dates & Truffles, Cookies)",
      "Video-Led Category Navigation",
      "SEO Optimized for Local Search (Al Khobar/Dammam)",
...

  {
    ...
    link: "sabawrites",
    location: "Lahore, Pakistan",
    stack: "NEXT.JS ✦ TYPESCRIPT ✦ MDX/CMS ✦ SEO",
    description:
      "Saba Writes is a personal fashion, beauty, and lifestyle blog covering makeup, skincare, and wardrobe trends. The platform was built for content-first publishing, with fast page loads, clean typography, and a blog architecture that supports frequent posting and strong organic search visibility.",
    problemStatement:
    ...
    features: [
      ...
      "Author/About Page",
      "Fast Static Rendering for SEO",
      "SSG/ISR for New Blog Posts",
