  ...
  return (
    <div ref={containerRef} className="relative max-w-6xl mx-auto w-full">
        <div className="relative w-full h-screen overflow-hidden" ref={imageBoxRef}>
            <Image ref={imageRef} src={thumbnail} alt={title + "thumbnail image"} width={1000} height={1000} className="absolute top-0 left-0 w-full h-[110%] md:h-[130%] object-cover object-center" />
        </div>
